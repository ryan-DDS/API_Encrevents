        ...
        <>
            <header className="fixed top-0 left-0 w-full z-50 h-16 grid grid-cols-3 items-center bg-black/30 backdrop-blur-md">
                ...
                <div className="flex gap-x-6 justify-center">
                    <a href="#events" className="text-gray-300 hover:text-white transition-all duration-300 text-sm tracking-widest">EVENTOS</a>
                    <a href="#footer" className="text-gray-300 hover:text-white transition-all duration-300 text-sm tracking-widest">SOBRE</a>
                    <a href="#artists" className="text-gray-300 hover:text-white transition-all duration-300 text-sm tracking-widest">ARTISTAS</a>
                </div>
                <div className="flex gap-x-4 justify-end items-center px-4">
                    ...
                    <a href="/cadastro" className="text-gray-300 hover:text-white transition-all duration-300">Cadastrar-se</a>
                </div>
